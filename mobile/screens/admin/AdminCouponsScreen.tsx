            ...
            coupons.map((coupon) => (
              <View key={coupon._id} style={styles.couponCard}>
                <View style={styles.couponHeader}>
                  ...
                  <View style={[styles.statusBadge, { backgroundColor: coupon.isActive ? '#4CAF50' : '#F44336' }]}>
                    <Text style={styles.statusText}>{coupon.isActive ? 'Active' : 'Inactive'}</Text>
                  </View>
                </View>
                ...
                <View style={styles.couponDetails}>
                  ...
                  <View style={styles.detailItem}>
                    ...
                    <Text style={styles.detailValue}>${coupon.minOrderAmount}</Text>
                  </View>
                  <View style={styles.detailItem}>
                    <Text style={styles.detailLabel}>Uses</Text>
                    <Text style={styles.detailValue}>{coupon.usedCount}/{coupon.maxUses}</Text>
                  </View>
                  <View style={styles.detailItem}>
                    <Text style={styles.detailLabel}>Expires</Text>
                    <Text style={styles.detailValue}>{new Date(coupon.expiryDate).toLocaleDateString()}</Text>
                  </View>
                </View>

                <View style={styles.progressBar}>
                  <View style={[styles.progressFill, { width: `${(coupon.usedCount / coupon.maxUses) * 100}%` }]} />
                </View>

                <View style={styles.actionRow}>
                  <Switch
                    value={coupon.isActive}
                    onValueChange={() => toggleCouponStatus(coupon._id, coupon.isActive)}
                    trackColor={{ false: '#ddd', true: '#4CAF50' }}
                  />
                  <View style={styles.actionButtons}>
                    <TouchableOpacity style={styles.iconBtn} onPress={() => deleteCoupon(coupon._id)}>
