      ...
      <PaperProvider>
        <SettingsProvider>
          ...
          screenOptions={{
            ...
            headerShown: false, // Hide headers for full-screen dashboards
          }}
        >
          <Stack.Screen
            name="Welcome"
          ...
          <Stack.Screen
            ...
            component={ManagerTabsNavigator}
          ...
          <Stack.Screen
            ...
            options={{ headerShown: false }}
          />
          {/* Tab screens - accessible from Stack for navigation */}
          <Stack.Screen
            name="AdminOrders"
          ...
          <Stack.Screen
            name="ChefDashboard"
            component={ChefTabsNavigator}
          />
          <Stack.Screen
            name="WaiterDashboard"
            component={WaiterTabsNavigator}
          />
          <Stack.Screen
            name="RiderDashboard"
          ...
          <Stack.Screen
            ...
            component={AdminProductSizesScreen}
          />
          <Stack.Screen
